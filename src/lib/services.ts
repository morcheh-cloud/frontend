...
export class HttpClient<SecurityDataType = unknown> {
  ...
  constructor({
    ...
    this.instance = axios.create({
      ...axiosConfig,
      baseURL: axiosConfig.baseURL || "http://127.0.0.1:3000",
    });
    this.secure = secure;
    this.format = format;
 ...
 * @contact Support Team <support@morcheh.io> (https://morcheh.io/support)
 *
 * The Morcheh API documentation
 */
export class Api<
...
> extends HttpClient<SecurityDataType> {
  ...
  playbooks = {
     ...
     *
     * @tags PLAYBOOKS
     * @name AnsibleControllerSyncAnsibleV1
     * @request POST:/v1/playbooks/sync
     * @secure
     */
    ansibleControllerSyncAnsibleV1: (params: RequestParams = {}) =>
      this.request<void, any>({
        path: `/v1/playbooks/sync`,
        method: "POST",
        secure: true,
        ...params,
      }),
