import { CloseButton, Dialog, type DialogBodyProps, type DialogRootProps, Portal } from "@chakra-ui/react"
...
const ModalRoot = ({ children, open, onClose, ...rest }: ModalRootProps) => {
	return (
		<Dialog.Root open={open} onOpenChange={onClose} scrollBehavior={"inside"} lazyMount {...rest}>
			{children}
		</Dialog.Root>
	)
}
